...
class Signin extends React.Component {
  ...
  onEmailChange = event => {
    ...
    this.setState({ signInEmail: event.target.value }, () => {
      this.validateField(signInEmailname, signInEmailvalue);
    });
  };
  ...
  onPasswordChange = event => {
    ...
    this.setState({ signInPassword: event.target.value }, () => {
      this.validateField(signInPasswordname, signInPasswordvalue);
    });
  };
    ...
    switch (fieldName) {
      ...
      case "signInPassword":
        ...
        fieldValidationErrors.Password = passwordValid
          ? ""
          : " Senha tem que ter no mínimo 3 digitos.";
        break;
      default:
        break;
    }
  ...
  credenciasIncorretas = bool => {
    return this.setState({ credenciasIncorretas: bool });
  };
