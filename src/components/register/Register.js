...
class Register extends React.Component {
  ...
  onNameChange = event => {
    ...
    this.setState({ nome: event.target.value }, () => {
      this.validateField(RegisterNameName, RegisterNamevalue);
    });
  };
  ...
  onEmailChange = event => {
    ...
    this.setState({ email: event.target.value }, () => {
      this.validateField(RegisterEmailName, RegisterEmailvalue);
    });
  };
  ...
  onPasswordChange = event => {
    ...
    this.setState({ senha: event.target.value }, () => {
      this.validateField(RegisterSenhaName, RegisterSenhavalue);
    });
  };
    ...
    switch (fieldName) {
      ...
      case "password":
        ...
        fieldValidationErrors.Password = passwordValid
          ? ""
          : "Insira uma senha maior que 3 dígitos.";
        break;
      case "name":
        ...
        <main className="pa4 white-80">
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div
                className={`mt3 ${this.errorClass(this.state.formErrors.Name)}`}
              >
